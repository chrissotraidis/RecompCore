...
void SlippiPlaybackStatus::setHardFFW(bool enable)
{
  if (enable)
  {
    ...
    Config::SetCurrent(Config::MAIN_OVERCLOCK, 4.0f);
  }
  else
  {
    Config::SetCurrent(Config::MAIN_OVERCLOCK, orig_OC_factor);
    Config::SetCurrent(Config::MAIN_OVERCLOCK_ENABLE, orig_OC_enable);
  }
