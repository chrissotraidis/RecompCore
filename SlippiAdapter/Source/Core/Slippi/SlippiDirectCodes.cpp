...
// These members are odr-used by the EXI device constructor.  Keep their
// storage in the shim so Debug and Release use the same link contract.
const uint8_t SlippiDirectCodes::DIRECT;
const uint8_t SlippiDirectCodes::TEAMS;
